...
/// way the in-memory SQLite test suite (see
/// <c>Microsoft.EntityFrameworkCore.SqliteDbContextOptionsBuilderExtensions</c>) does
/// <b>not</b> validate filtered-index <i>selectivity</i> — it only
