...
The story requires "P95 send latency under 2 seconds after event is queued." This architecture defines the following canonical latency metrics (all sibling documents — tech-spec.md, implementation-plan.md, e2e-scenarios.md — are converged on these names and measurement points):
