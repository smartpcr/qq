...
| Constraint | Source |
|------------|--------|
| C# / .NET 8+ | Epic-level mandate (story description specifies C# SDKs; .NET 8 is the current LTS release and the team's standard runtime). |
